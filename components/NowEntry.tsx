...
export function NowEntry({
        ...
        return (
            <div className="mb-8 w-full" data-testid="now-entry">
                ...
                <div className="max-w-3xl">
                    <div
                        className="prose dark:prose-invert prose-a:text-emerald-500 hover:prose-a:text-emerald-600 prose-a:no-underline"
    ...
    return (
        <Collapsible
            ...
            <CollapsibleContent
                className="mt-4 prose dark:prose-invert prose-a:text-emerald-500 hover:prose-a:text-emerald-600 prose-a:no-underline"
                data-testid="now-entry-content">
                {children}
            </CollapsibleContent>
        </Collapsible>
