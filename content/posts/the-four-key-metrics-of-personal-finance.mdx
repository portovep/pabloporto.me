...
type: 'Post'
tag: 'life-updates'
description: 'Borrowing the DevOps four key metrics framework to track personal finance: saving rate, investment rate, total debt, and emergency fund runway.'
---
